...
export declare enum ModuleLoaderTypes {
    EXTENSION = 0,
    CONTROLLER = 1,
    MEDIA = 2,
    PLAYER = 3
...
export declare type Cuepoint = 'preroll' | 'postroll' | number;
...
export declare type EventCallback = any;
export declare enum KeyboardNavigationPurpose {
    PAUSE = "pause",
    PLAY = "play",
    PREV_SEEK = "prev-seek",
    NEXT_SEEK = "next-seek",
...
export declare type NextHook = (...args: any) => void;
export interface IHooks {
    create(name: string, callback: NextHook): any;
}
export interface IModuleLoader<T> {
    type: ModuleLoaderTypes;
    create(instance: IInstance): T;
    isSupported(instance: IInstance, isSupportedArgs?: any): boolean | Promise<boolean>;
}
/**
 * Addition types
